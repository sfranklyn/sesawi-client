...
public class BarCodeKeyListener implements KeyListener {
    ...
    public BarCodeKeyListener(ExitDoorForm edf, TicketsServiceBean ticketsServiceBean) {
        this.edf = edf;
    ...
    public void keyReleased(KeyEvent ke) {
        ...
        String barCode = edf.getFieldBarcode().getText().toUpperCase().concat("%");
        edf.getListModelTickets().clear();
        edf.setTicketsListMap(ticketsServiceBean.receiveEntryByTicketNo(barCode));
